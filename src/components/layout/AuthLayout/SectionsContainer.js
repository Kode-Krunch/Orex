...
const SectionsContainer = ({
  ...
  return (
    <div>
      <div className="ud-header absolute left-0 top-0 z-10 flex w-full items-center bg-transparent">
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex items-center justify-end pr-16 lg:pr-0">
              <div className="hidden sm:flex">
                <p
                  className="loginBtn px-[22px] py-2 text-base font-medium text-white hover:opacity-70 cursor-pointer"
                ...
                <p
                  onClick={() => {
                    ...
                    handleFormDataChange({ PlanID: 2 });
                  }}
                  className="signUpBtn rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-darkk"
                >
                  Try Demo
                </p>
                <p
                  ...
                  className="signUpBtn ml-2 rounded-md bg-[#00e4cb] bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-darkk"
                >
                  Admin
                </p>
              </div>
      ...
      <div
        id="home"
        className="relative overflow-hidden primaryLanding pt-[120px] md:pt-[130px] lg:pt-[160px]"
      >
        <div className="containerLanding">
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Welcome To{' '}
                  <span className="text-wrapper-11"> Cloud BATS</span> Your
                  Trusted Partner
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  in revolutionizing Ad Scheduling and Billing for broadcasters
                  and radio operators!
                </p>
              </div>
            </div>
      ...
      <section className="pb-8 pt-20 dark:bg-darkLanding lg:pb-[70px] lg:pt-[120px]">
        <div className="containerLanding">
            ...
            <div className="w-full px-4">
              <div className="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  Revolutionizing Broadcast Scheduling
                </p>
              </div>
            </div>
          </div>
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
                <div className="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] primaryLanding">
                  <span className="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] primaryLanding bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                  <svg
                    width="37"
                    height="37"
                    viewBox="0 0 37 37"
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  Access your broadcast scheduling system from anywhere with our
                  secure, scalable cloud platform, ensuring real-time data
                  availability and seamless performance.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  Leverage advanced AI-driven analytics to gain valuable
                  insights into scheduling patterns, optimize airtime usage, and
                  boost revenue through smart decision-making.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".2s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  Cloud BATS offers smart booking, clash detection,
                  multi-commercial handling, and real-time notifications,
                  designed to streamline your broadcast scheduling workflow.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".25s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  Compatible with various playout systems, accounting tools like
                  Tally and SAP, and external integrations, ensuring smooth
      ...
      <section
        id="about"
        className="bg-gray-1 pb-8 pt-20 dark:bg-darkLanding-2 lg:pb-[70px] lg:pt-[120px]"
      >
        <div className="containerLanding">
              ...
              <div className="w-full px-4 lg:w-1/2">
                <div className="mb-12 max-w-[540px] lg:mb-0">
                  ...
                  <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                    Cloud BATS is a state-of-the-art broadcast airtime
                    scheduling system designed to streamline and optimize the
                    scheduling process for media broadcasters. Leveraging the
                    power of cloud technology, advanced AI analytics, and
                    seamless integrations, Cloud BATS empowers users to manage
                    their broadcast operations with efficiency and precision
                    <br />
                    <br />
                    Cloud BATS is designed to grow with your business. Whether
                    you’re expanding your operations or integrating new
                    features, our flexible platform can adapt to your evolving
                    needs.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full px-4 lg:w-1/2">
                <div className="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                  ...
                  <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                    ...
                    <div className="relative z-10 mb-4 flex items-center justify-center overflow-hidden primaryLanding px-6 py-12 sm:mb-8 sm:h-[160px] sm:p-5 lg:mb-4 xl:mb-8">
                      <div>
      ...
      {/* <section
        id="pricing"
        className="relative z-20 overflow-hidden bg-white pb-12 pt-20 primaryLanding lg:pb-[90px] lg:pt-[120px]"
      >
        <div className="containerLanding mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            {segmentSelections.map((items, key) => (
              <div className="w-full px-4 md:w-1/2 lg:w-1/3" key={key}>
                <div className="relative z-10 mb-10 overflow-hidden rounded-xl bg-white px-8 py-10 shadow-pricing dark:bg-darkLanding-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14">
                  {items.recommended && (
                    <p className="absolute right-[-50px] top-[60px] inline-block -rotate-90 rounded-bl-md rounded-tl-md primaryLanding px-5 py-2 text-base font-medium text-white">
                      Recommended
                    </p>
                  )}
                  ...
                  <h2 className="mb-11 text-4xl font-semibold text-dark dark:text-white xl:text-[42px] xl:leading-[1.21]">
                    <span className="text-xl font-medium"> {items.Symbol}</span>
                  ...
                  <p
                    onClick={() => {
                      setIsTryDialogOpen(true);
                      handleFormDataChange({ PlanID: items.value });
                    }}
                    className="inline-block rounded-md primaryLanding px-7 py-3 text-center text-base font-medium text-white transition hover:bg-blue-dark cursor-pointer"
                  >
                    Purchase Now
                  </p>
                </div>
      ...
      <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-darkLanding lg:pb-[50px] lg:pt-[120px]">
        <div className="containerLanding mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[520px] text-center">
                ...
                <p className="mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6">
                  Explore our FAQ section to discover helpful answers to
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px]">
                <div className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl primaryLanding text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 34 34"
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Is Cloud BATS compatible with multiple playout systems?
                  </h3>
                  <p className="text-base text-body-color dark:text-dark-6">
                    Yes, Cloud BATS integrates seamlessly with various playout
                    systems. This compatibility allows for efficient data
                    exchange using export formats or direct API-based
                    integration, ensuring smooth operations regardless of the
                    playout technology used.
                  </p>
                </div>
              </div>
              <div className="mb-12 flex lg:mb-[70px]">
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    What kind of customer support does Cloud BATS offer?
                  </h3>
                  <p className="text-base text-body-color dark:text-dark-6">
                    Cloud BATS provides comprehensive customer support,
                    including onboarding assistance, training sessions, and
                    ongoing technical support. Our dedicated support team is
                    available to help users with any questions or issues they
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px]">
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Can Cloud BATS scale with my business growth?
                  </h3>
                  <p className="text-base text-body-color dark:text-dark-6">
                    Yes, Cloud BATS is designed to scale with your business
                    needs. Whether you are expanding your scheduling operations
                    or adding new features, the cloud-based infrastructure
                    allows for flexible resource allocation and scaling options
              ...
              <div className="mb-12 flex lg:mb-[70px]">
                ...
                <div className="w-full">
                  <h3 className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Does Cloud BATS track revenue leakages?
                  </h3>
                  <p className="text-base text-body-color dark:text-dark-6">
                    Yes, Cloud BATS features advanced dashboard modules
                    specifically designed to track revenue leakages. These
                    dashboards provide insights into potential areas of loss,
                    allowing users to make informed decisions and optimize their
                    scheduling strategies to maximize revenue.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* <section
        id="team"
        className="overflow-hidden bg-gray-1 pb-12 pt-20 dark:bg-darkLanding-2 lg:pb-[90px] lg:pt-[120px]"
      >
        <div className="containerLanding mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
              <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-darkLanding dark:shadow-none">
                <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  ...
                  />
                  <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-secondaryLanding opacity-0 transition-all group-hover:opacity-100"></span>
      ...
      <section id="contact" className="relative py-20 md:py-[120px] ">
        <div className="absolute left-0 top-0 -z-[1] h-full w-full dark:bg-darkLanding"></div>
        <div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-darkLanding  lg:h-[45%] xl:h-1/2"></div>
        <div className="containerLanding px-4">
          <div className="-mx-4 flex flex-wrap items-center">
                ...
                <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                  <div className="mb-8 flex w-[330px] max-w-full">
                    ...
                    <div>
                      ...
                      <p className="text-base text-body-color dark:text-dark-6">
                        CTS No 1627, Royal Palms, Goregaon, Mumbai, India
                      </p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-[330px] max-w-full">
            ...
            <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
              <div
                className="wow fadeInUp rounded-lg bg-white px-8 py-10 shadow-testimonial dark:bg-darkLanding-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
                data-wow-delay=".2s
              "
              >
                ...
                <form>
                  ...
                  <div className="mb-0">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center rounded-md primaryLanding px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-blue-dark"
                    >
                      Send
                    </button>
                  </div>
      ...
      {/* <section className="pb-20 dark:bg-darkLanding">
        <h1 className='ml-9' >Our Clients</h1>
        <div className="containerLanding px-4">
          <div className="-mx-4 flex flex-wrap items-center justify-center gap-8 xl:gap-11">
            <a href="https://graygrids.com/">
           
              <img
                src="data:image/png;base64,"
                alt="graygrids"
            ...
            <a href="https://lineicons.com/">
              <img
                src="data:image/jpeg;base64,"
                alt="lineicons"
