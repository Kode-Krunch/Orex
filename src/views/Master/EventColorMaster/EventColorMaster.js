...
const EventColorMaster = () => {
  ...
  useEffect(() => {
    (async (values) => {
      const resp = await apiGetEventColorMaster(values);
      setdata(resp.data);
    })();
  }, []);
  const openDrawer = () => {
  ...
  return (
    <>
      ...
      <Card
        header={<HeaderExtra Component={'Event Color Master'} />}
...
export default EventColorMaster;
