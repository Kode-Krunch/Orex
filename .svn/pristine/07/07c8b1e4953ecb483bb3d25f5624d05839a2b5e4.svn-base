      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-1">
          <FormItem
            asterisk
            label="Agency"
            invalid={errors.Agency && touched.Agency}
          ...
          >
            <Field
              ...
              options={Agency}
              value={Agency.filter(
                (option) => option.value === values.Agency,
              )}
              onChange={(e) => {
                const newValue = e.value;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="col-span-1">
            <FormItem
              ...
              invalid={errors.is2FAAllowed && touched.is2FAAllowed}
              errorMessage={errors.is2FAAllowed}
            >
              <div>
                <Field size="sm" name="is2FAAllowed" component={Switcher} />
              </div>
            </FormItem>
          </div>
        </div>
