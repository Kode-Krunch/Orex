...
const ActivityLog = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        setDateWiseNotifications(getDateWiseNotifications(notifications));
