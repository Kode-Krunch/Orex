...
const SceneTypeMaster = () => {
    ...
    useEffect(() => {
        ; (async (values) => {
            const resp = await apiGetSceneTypeMaster(values)
    ...
    return (
        <>
            ...
            <Card
                header={<HeaderExtra Component={'SceneType Master'} />}
            ...
            >
                <DisplayTable
                    ...
                    ExportName={'SceneTypeMaster'}
                />
            </Card>

            <Drawer
                title={
                    editData.SceneTypeName ? (
...
export default SceneTypeMaster
