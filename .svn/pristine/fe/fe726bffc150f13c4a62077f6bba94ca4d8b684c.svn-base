...
const loadThemePreferences = () => {
  ...
  return {
    mode: savedMode || themeConfig.mode,
    navMode: savedNavMode || initialNavMode(),
  };
};

const { mode, navMode } = loadThemePreferences();
const updatedInitialState = { ...initialState, mode, navMode };
