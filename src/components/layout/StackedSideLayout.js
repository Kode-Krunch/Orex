...
import NotificationDropdown from 'views/Controls/NotificationDropdown';
        ...
        {window.localStorage.getItem('OneSolutionURL') && (
          <Button
            ...
            onClick={() => {
              ...
              window.location.href =
                'https://telstra-pam.planetcast.in/pam/' +
                '/?token=' +
  ...
  return (
    <div className="flex items-center">
      ...
      {Channel?.label !== CLIENT.FOOD_INDIA &&
        Channel?.label !== CLIENT.FOOD_USA && <NotificationDropdown />}
      <SidePanel />
