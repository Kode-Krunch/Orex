...
function PaymentFailedDialog({ isOpen, setIsOpen, refNumber, setRefNumber }) {
  /* EVENT HANDLERS */
  const handleClose = () => {
    setIsOpen(false);
    setRefNumber('');
  ...
  return (
    <Dialog isOpen={isOpen} onClose={handleClose} onRequestClose={handleClose}>
      <h5 className="mb-4">Payment Failed</h5>
      <div className="h-[40vh] flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex flex-col justify-center gap-2">
          <p className="text-gray-200 text-base text-center">Payment Failed</p>
          {refNumber && (
            <p>
