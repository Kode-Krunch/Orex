...
function AddEditEvent({
  ...
  return (
    <Card
      header={isHeaderShow && <HeaderExtra Component={'Event Management'} />}
      headerExtra={isHeaderShow &&
        <>
      ...
      >
        <div className="flex gap-3">
          ...
          <Button
            variant="solid"
            icon={<IoSaveOutline />}
            onClick={curView === viewsEnum.ADD || clickedActionRowData == "" ? handleSave : handleUpdate}
            disabled={
              !selectedEvent ||
              Object.keys(groupWiseSelectedEntities).length === 0 ||
