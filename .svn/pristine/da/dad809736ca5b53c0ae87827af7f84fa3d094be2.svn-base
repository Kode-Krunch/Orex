...
const segmentSelections = [
  {
    ...
    price: '0',
    recommended: false,
    desc: 'The plan for 15 Days.',
    rules: [
      { rule: 'Unlimited Support ', checked: true },
      { rule: '5GB Server Space', checked: true },
      { rule: '1 Users per Project', checked: true },
      { rule: 'Customer Management', checked: false },
      { rule: 'All Features', checked: false },
    ],
  },

  {
    ...
    recommended: true,
    price: '1,000',
    desc: 'The plan for 6 Monthly',
    rules: [
      { rule: 'Unlimited Support ', checked: true },
      { rule: '100GB Server Space', checked: true },
      { rule: '5 Users per Project', checked: true },
      { rule: 'Customer Management', checked: false },
      { rule: 'All Features', checked: false },
    ],
  },

  {
    ...
    priceOff: '20%',
    recommended: false,
    desc: 'Talk to us for premium plan.',
    rules: [
      { rule: 'Unlimited Support ', checked: true },
      { rule: '1000GB Server Space', checked: true },
      { rule: '10 Users per Project', checked: true },
      { rule: 'Customer Management', checked: true },
      { rule: 'All Features', checked: true },
    ],
  },
];
...
export { countries_city, BusinessType, segmentSelections, Admin_COLUMNS };
