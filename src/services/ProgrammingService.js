...
export async function apiGetSubGenremaster(LocationCode, ChannelCode) {
  return ApiService.fetchData({
    url: `/SubGenreMaster/?LocationCode=${LocationCode}&ChannelCode=${ChannelCode}`,
    method: 'get',
  });
}
export async function apiGetSubGenremasterDrop(LocationCode, ChannelCode) {
  return ApiService.fetchData({
    url: `/SubGenreMaster/drop/?LocationCode=${LocationCode}&ChannelCode=${ChannelCode}`,
    method: 'get',
  });
}
...
const Postpromotype = (param, token) => {
  return new Promise((resolve, reject) => {
    let data = JSON.stringify({
      ...
      EventDefaultFrontColor: param.EventDefaultFrontColor,
      EventDefaultBackColor: param.EventDefaultBackColor,
      IsActive: param.IsActive ? 1 : 0,
    });
...
export async function apiGetContenStarCast(ContentCode) {
  return ApiService.fetchData({
    url: `/contenstarcast/${ContentCode}`,
    method: 'get',
  });
}
export async function apiPostContenStarCast(ContentCode, data) {
  return ApiService.fetchData({
    url: `/contenstarcast/`,
    method: 'post',
    data,
...
export const apiGetMarkNotifAsRead = () => {
  return ApiService.fetchData({
    url: '/notification/read_notifications',
  });
};
...
export async function PostContentNew(data) {
  return ApiService.fetchData({
    url: `/contentmaster/ContentaddNew/`,
    method: 'post',
    data,
  });
}
...
const PutContent = (param, token, DefaultImage) => {
  return new Promise((resolve, reject) => {
    let data = JSON.stringify({
...
const PutContentsports = (param, token, DefaultImage) => {
  return new Promise((resolve, reject) => {
    let data = JSON.stringify({
      ContentName: param.ContentName,
      ShortName: param.ShortName,
      ...
      InHouseOutHouse: param.InHouseOutHouse ? 1 : 0,
      FPCReleaseDate: param.FPCReleaseDate,
      ContentKilldate: param.ContentKilldate,
      Synopsis: param.Synopsis,
      GroupName: param.GroupName,
...
export async function deletedailyfpcAprovel(
  LocationCode,
  ChannelCode,
  TelecastDate,
) {
  return ApiService.fetchData({
    url: `/dailyfpc_delete/?LocationCode=${LocationCode}&ChannelCode=${ChannelCode}&TelecastDate=${TelecastDate}`,
    method: 'get',
  });
}
export async function dailyfpcAprovelSpots(
  LocationCode,
  ChannelCode,
  TelecastDate,
) {
  return ApiService.fetchData({
    url: `/dailyfpc_Spots/?LocationCode=${LocationCode}&ChannelCode=${ChannelCode}&TelecastDate=${TelecastDate}`,
    method: 'get',
  });
}
...
export async function apiexportpayout(
  LocationCode,
  ChannelCode,
  TelecastDate,
  UploadFilePath = 'EDIT',
...
export async function apiGetTeamMasterDropLocalEventWise(IsSubProgram) {
  return ApiService.fetchData({
    url: `/teammaster/droplocaleventwise/${IsSubProgram}`,
    method: 'get',
  });
}

export async function apiEventMasterCreateNew(data) {
  return ApiService.fetchData({
    url: `/eventmaster/new/`,
    method: 'post',
    data,
...
export async function apiGetContentMaster(
  locationCode,
  channelCode,
  search,
  isGroup = 0,
  ...
  return ApiService.fetchData({
    url: `/contentmaster/?LocationCode=${locationCode}&ChannelCode=${channelCode}&IsGroup=${isGroup}&EventContentCode=${eventContentCode}&search=${search}`,
    method: 'get',
  });
}
