...
import { setCommMasterSearchKeyword } from 'store/sectionWiseState/commMasterSlice';
  ...
  return (
    <div className="flex items-center">
      ...
      <span className="mr-1   font-semibold">
        <InputwithVoice
          value={commMasterSearchKeyword}
          className=" solid"
          placeholder="Search all columns..."
          size="sm"
          onChange={(e) => {
            dispatch(setCommMasterSearchKeyword(e.target.value));
          }}
        />
      </span>
      <span className="mr-1 font-semibold">
...
const CommercialMaster = () => {
  ...
  const commMasterSearchKeyword = useSelector(
    (state) => state.commMaster,
  ).commMasterSearchKeyword;
    ...
    <>
      ...
      >
        ...
        <ReportsTable
          ...
          externalGlobalFilter={commMasterSearchKeyword}
