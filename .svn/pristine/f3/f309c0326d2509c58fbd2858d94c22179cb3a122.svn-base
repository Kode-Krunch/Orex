            ...
            <TabList className="border-b !border-b-gray-600 pb-1">
              {SHOW_MOVIES_TAB && (
                <TabNav
                  ...
                  className={`${activeTab === eventTypesEnum.MOVIE &&
              ...
              {SHOW_CONTENTS_TAB && (
                <TabNav
                  ...
                  className={`${activeTab === eventTypesEnum.CONTENT &&
                    '!text-white !bg-teal-700'
                    }`}
                >
                  Contents12 ({EVENT_TYPEWISE_CONTENTS.Content.length})
                </TabNav>
              )}
              {SHOW_SONGS_TAB && (
                <TabNav
                  value={eventTypesEnum.SONG}
                  className={`${activeTab === eventTypesEnum.SONG &&
                    '!text-white !bg-teal-700'
                    }`}
                >
