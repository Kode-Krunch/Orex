...
const AttachmentRow = ({ Attachment, setAttachment, handleDownloadAndView, }) => {
    return (
        Attachment && (
            <div className="mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    {Attachment.length == 0 ? <p className='flex justify-center items-center'>Not File Attached</p> : Attachment.map((item, index) => {
