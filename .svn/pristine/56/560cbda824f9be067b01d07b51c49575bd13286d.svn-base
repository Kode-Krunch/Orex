        ...
        <Tooltip title="Rotation Info">
          ...
          <Tooltip title="Download Template">
            <Button
              ...
              onClick={handleDownloadFPCImport}
            />
          </Tooltip>
          <Tooltip title="Upload FPC">
            ...
            <UploadFileValidateAndSubmitDialog
              ...
              fileUploadapi={
                channel.label == CLIENT.ASIANET ? 'fpcmaster/uploadFileNewFormat_AsiaNetChannel' :
                  channel.label == CLIENT.KINA_U || channel.label == CLIENT.VIJAY_TAKKER
                    ? 'fpcmaster/uploadFileNewFormat_VIJAYTV'
                    : channel.label == CLIENT.MASST_INDIA ||
                      ...
                      channel.label == CLIENT.NEWS_INDIA ||
                      channel.label == CLIENT.INDIA_GEC ||
                      channel.label == CLIENT.INDIA_SPORTS
                      ? 'fpcmaster/uploadFileStandardFormat' //Basic Validation Available in StandardFormat.
